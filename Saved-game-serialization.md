...
Note that classes like Texture should not be serialized is most cases. It would be better to not have a string instead of a Texture object in your object graph. After serializing you would process the objects and look up the texture using the string path.
