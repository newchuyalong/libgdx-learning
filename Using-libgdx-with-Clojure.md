...
* The [Nightcode](https://nightcode.info/) IDE allows you to create and run a play-clj project without installing Leiningen. You simply click the "New Project" button, give it a name, and choose the Game template.
* The [Nightmod](https://nightmod.net/) game tool provides an easier way to use play-clj by integrating the game and the text editor together so you can see instant results when you save your code.